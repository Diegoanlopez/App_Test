...
public final class SpinnerItemBinding implements ViewBinding {
  ...
  private SpinnerItemBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView itemImage,
  ...
  public static SpinnerItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new SpinnerItemBinding((ConstraintLayout) rootView, itemImage, itemName);
    }
